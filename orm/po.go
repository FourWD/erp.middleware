...
type Po struct {
	...
	Discount       float64 `json:"discount_price" query:"discount_price" gorm:"type:decimal(14,2)"`
	DiscountRemark float64 `json:"discount_remark" query:"discount_remark" gorm:"type:decimal(14,2)"`

	Price    float64 `json:"price" query:"price" gorm:"type:decimal(14,2)"` // ค่า sumary ของ customer_id นี้
	NetPrice float64 `json:"total_price" query:"total_price" gorm:"type:decimal(14,2)"`

	PaymentDate time.Time // วันที่รับเงิน
