...
type Booking struct {
	...
	// show user_type_id
	ReferalChannelID string `json:"referal_channel_id" query:"referal_channel_id" gorm:"type:varchar(2)"` //ช่องทางที่แนะนํา
	// ref sub for booking tar
	ReferalChannelSubID string     `json:"referal_channel_sub_id" query:"referal_channel_sub_id" gorm:"type:varchar(2)"` //ช่องทางย่อยที่แนะนํา
	ReferalName         string     `json:"referal_name" query:"referal_name" gorm:"type:varchar(256)"`                   // ชื่อผู้แนะนํา
