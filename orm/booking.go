...
type Booking struct {
	...
	// show user_type_id
	ReferralChannelID string `json:"referral_channel_id" query:"referral_channel_id" gorm:"type:varchar(2)"` // ช่องทางการแนะนํา
	// ref sub for booking tar
	ReferalChannelSubID string     `json:"referral_channel_sub_id" query:"referral_channel_sub_id" gorm:"type:varchar(2)"`
