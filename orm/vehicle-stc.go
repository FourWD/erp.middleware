...
type VehicleSTC struct {
	...
	RemarkTitle                string `json:"remark_title" query:"remark_title" gorm:"type:text"`

	IsImport bool `json:"is_import" query:"is_import" gorm:"type:bool"`
	// name from api import
	RefCarId               int     `json:"ref_car_id" query:"ref_car_id" gorm:"type:int"`
	RefCarSoldType         string  `json:"ref_car_sold_type" query:"ref_car_sold_type" gorm:"type:varchar(255)"`
	RefVehicleBranchCode   string  `json:"ref_vehicle_branch_code" query:"ref_vehicle_branch_code" gorm:"type:varchar(255)"`
	RefVehicleTypeName     string  `json:"ref_vehicle_type_name" query:"ref_vehicle_type_name" gorm:"type:varchar(255)"`
	RefVehicleBrandName    string  `json:"ref_vehicle_brand_name" query:"ref_vehicle_brand_name" gorm:"type:varchar(255)"`
	RefVehicleModelName    string  `json:"ref_vehicle_model_name" query:"ref_vehicle_model_name" gorm:"type:varchar(255)"`
	RefVehicleSubModelName string  `json:"ref_vehicle_sub_model_name" query:"ref_vehicle_sub_model_name" gorm:"type:varchar(255)"`
	RefVehicleColorName    string  `json:"ref_vehicle_color_name" query:"ref_vehicle_color_name" gorm:"type:varchar(255)"`
	RefLicenseProvinceName string  `json:"ref_license_province_name" query:"ref_license_province_name" gorm:"type:varchar(255)"`
	RefCarStatus           string  `json:"ref_car_status" query:"ref_car_status" gorm:"type:varchar(255)"`
	RefMile                int     `json:"ref_mile" query:"ref_mile" gorm:"type:int(11)"`
	RefPriceIncVat         float64 `json:"ref_price_inc_vat" query:"ref_price_inc_vat" gorm:"type:decimal(14,2)"`

	// CostMA int // ต้นทุนการปรับสภาพรถ

	ImageCount        int    `json:"image_count" query:"image_count" gorm:"type:int"`
	RunningNo         int64  `gorm:"column:running_no" json:"running_no" gorm:"autoIncrement"`
	VehicleBranchCode string `gorm:"column:vehicle_branch_code" json:"vehicle_branch_code"`
	CarStatus         string `gorm:"column:car_status" json:"car_status"`
}

func (VehicleSTC) TableName() string {
	return "vehicle_stc"
}
